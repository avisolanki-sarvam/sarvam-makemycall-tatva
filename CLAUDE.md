...
- The user is **Avi**. He's building this with two other devs (Dev A=mobile,
  Dev B=backend, Dev C=Samvaad+LLM).
- Inline styles per screen via StyleSheet. `src/components/` stays empty
  until a real shared component pattern emerges.
